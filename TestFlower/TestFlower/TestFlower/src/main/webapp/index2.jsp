...
<!--                <div class="cart">
        ...
        <div class="shop-container">
            <div class="products row row-small large-columns-4 medium-columns-3 small-columns-2 equalize-box center-align">
                <%
                    ...
                    int currentPage = 0; // Trang hiện tại, ban đầu là trang đầu tiên
                    int displayedCount = 0; // Biến đếm số sản phẩm đã được hiển thị
                    ...
                    while (rs.next()) {
                        if (displayedCount >= productsPerPage) {
                            // Đạt đến số lượng sản phẩm trên mỗi trang, dừng vòng lặp
                            break;
                        }

                        // Kiểm tra điều kiện để hiển thị sản phẩm từ ID 30 trở đi
                        if (displayedCount >= (currentPage * productsPerPage) && rs.getInt("ID") >= 30) {
                            // Hiển thị sản phẩm
                %>
                <div class="flower">
                    <div class="col-inner">
                ...
                <%
                            displayedCount++; // Tăng biến đếm số sản phẩm đã được hiển thị
                        }
                    }
                %>
            </div>  
        ...
        <div class="container-123">
            ...
            <ul class="pagination">
                ...
                <li><a class="page-number" href="index.jsp">1</a></li>
                <li><span aria-current="page" class="page-number current">2</span></li>
                <li><a class="next page-number" href="index3.jsp"><i class="icon-angle-right"></i>></a></li>   
            </ul>
        </div>
