    ...
    <body>
        ...
        <div class="menu" id="flower-list"> <!--content menu-->
            <div class="products row row-small large-columns-4 medium-columns-3 small-columns-2 equalize-box center-align">
                ...
                <li><a href="hoachucmung.jsp" class="dropbtn">Hoa Chúc Mừng</a></li><!-- comment -->
            </div>
        </div>
        ...
        <div class="shop-container" >
            ...
            <div class="products row row-small large-columns-4 medium-columns-3 small-columns-2 equalize-box center-align">
                <%
                    ...
                    String keyword = request.getParameter("keyword"); // Lấy từ khóa tìm kiếm từ request parameter

                    if (keyword != null && keyword.equalsIgnoreCase("hoa hồng")) {
                        // Chuyển hướng đến trang hiển thị thông tin về hoa hồng (rose.jsp)
                        response.sendRedirect("hoahong.jsp");
                        return; // Kết thúc xử lý để tránh hiển thị trang `flowers.jsp`
                    }
